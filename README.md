...
## Captures — toutes les fonctions

### Accueil

Tableau de bord : substances en cours, TakoAI, cartes utiles (alertes, stats, RdR, mises à jour).

<p align="center">
  <img src="screenshots/ftp-home-fixed.png" alt="Accueil" width="820" />
</p>
<p align="center">
  <img src="artifacts/mobile-shots/home-hero.png" alt="Accueil mobile" width="280" />
  &nbsp;
  <img src="artifacts/mobile-shots/home-cards.png" alt="Cartes accueil" width="280" />
  &nbsp;
  <img src="screenshots/qa-now-banner.png" alt="Bandeau expérience en cours" width="280" />
</p>

### TakoAI — recherche & assistant

Questions, actions (ajouter une dose, changer le thème), photo pour estimer un dosage.

<p align="center">
  <img src="screenshots/qa-search.png" alt="TakoAI" width="400" />
  &nbsp;
  <img src="artifacts/mobile-shots/search.png" alt="Recherche mobile" width="280" />
  &nbsp;
  <img src="screenshots/qa-chat-camera.png" alt="Photo dosage" width="280" />
</p>

### Journal (Logs)

Expériences, ingestions, échelle de Shulgin, notes, médias, musique.

<p align="center">
  <img src="screenshots/qa-logs-filled.png" alt="Journal rempli" width="400" />
  &nbsp;
  <img src="screenshots/qa-logs-list.png" alt="Liste des logs" width="400" />
</p>
<p align="center">
  <img src="screenshots/qa-add-modal.png" alt="Ajouter une substance" width="400" />
  &nbsp;
  <img src="screenshots/qa-plus.png" alt="Bouton +" width="400" />
</p>
<p align="center">
  <img src="screenshots/qa-log-with-dose.png" alt="Log avec dose" width="400" />
  &nbsp;
  <img src="screenshots/qa-added.png" alt="Substance ajoutée" width="400" />
</p>

### Timeline & courbes

Montée, pic, descente ; hauteur selon le dosage ; zoom ; fréquence cardiaque.

<p align="center">
  <img src="screenshots/qa-curve-final.png" alt="Courbe" width="400" />
  &nbsp;
  <img src="screenshots/qa-home-curve.png" alt="Courbe accueil" width="400" />
</p>
<p align="center">
  <img src="screenshots/qa-curve-hover.png" alt="Survol courbe" width="400" />
  &nbsp;
  <img src="screenshots/qa-heart-rate.png" alt="Fréquence cardiaque" width="400" />
</p>

### Substances

~328 fiches (doses, durées, neurotransmetteurs, structure, statut légal).

<p align="center">
  <img src="screenshots/qa-substances-desktop.png" alt="Liste substances" width="820" />
</p>
<p align="center">
  <img src="screenshots/qa-lsd.png" alt="Fiche LSD" width="400" />
  &nbsp;
  <img src="screenshots/qa-lsd-docs.png" alt="Docs LSD" width="400" />
</p>
<p align="center">
  <img src="artifacts/mobile-shots/mdma.png" alt="Fiche MDMA" width="280" />
  &nbsp;
  <img src="screenshots/qa-mephedrone.png" alt="Mephedrone" width="400" />
</p>

### Comparer

Superposer deux courbes d’effets.

<p align="center">
  <img src="screenshots/page-compare.png" alt="Comparer" width="820" />
</p>

### Alertes labo

Retours de tests (Druglab, SINTES…).

<p align="center">
  <img src="artifacts/mobile-shots/alerts.png" alt="Alertes" width="280" />
  &nbsp;
  <img src="artifacts/mobile-shots/piece-alert-card.png" alt="Carte alerte" width="400" />
</p>

### Expériences (Erowid / Psychoactif)

Retours d’utilisateurs, pas des descriptions de substances.

<p align="center">
  <img src="artifacts/mobile-shots/experiences.png" alt="Expériences" width="280" />
</p>

### Neurotransmetteurs

<p align="center">
  <img src="artifacts/mobile-shots/neuro.png" alt="Neuro" width="280" />
</p>

### Réduction des risques

Interactions, conseils, hydratation, trip-sitter.

<p align="center">
  <img src="artifacts/mobile-shots/reduction.png" alt="Réduction des risques" width="280" />
</p>

### Connexion & inscription

Compte, captcha, mot de passe oublié.

<p align="center">
  <img src="screenshots/qa-login.png" alt="Connexion" width="400" />
  &nbsp;
  <img src="screenshots/ftp-after-signup.png" alt="Après inscription" width="400" />
</p>

### Profil

Photo, thème, emojis, noms personnalisés, langue, mot de passe, reset.

<p align="center">
  <img src="screenshots/qa-profile.png" alt="Profil" width="400" />
  &nbsp;
  <img src="screenshots/qa-appearance.png" alt="Apparence" width="400" />
</p>
<p align="center">
  <img src="screenshots/qa-emoji-picker.png" alt="Sélecteur emoji" width="400" />
  &nbsp;
  <img src="screenshots/qa-profile-en.png" alt="Profil anglais" width="400" />
</p>

### Notifications

Cloche, badge, hydratation, mélanges, pic / montée / descente.

<p align="center">
  <img src="screenshots/qa-inbox-final.png" alt="Notifications" width="400" />
  &nbsp;
  <img src="screenshots/qa-inbox-centered.png" alt="Inbox centrée" width="400" />
</p>

### Téléchargements

Explorateur type Mac : dossiers, tri, zip, suppression.

<p align="center">
  <img src="screenshots/qa-downloads.png" alt="Téléchargements" width="820" />
</p>

### Thèmes

Sable, lagon, mauve, clair / sombre / auto, monochrome.

<p align="center">
  <img src="screenshots/theme-dark-sable.png" alt="Sable sombre" width="270" />
  &nbsp;
  <img src="screenshots/theme-light-lagon.png" alt="Lagon clair" width="270" />
  &nbsp;
  <img src="screenshots/qa-theme-mauve.png" alt="Mauve" width="270" />
</p>
<p align="center">
  <img src="screenshots/theme-dark-lagon.png" alt="Lagon sombre" width="400" />
  &nbsp;
  <img src="screenshots/theme-dark-mauve.png" alt="Mauve sombre" width="400" />
</p>

### Mobile (PWA iOS)

Dock Liquid Glass, Dynamic Island, icône transparente.

<p align="center">
  <img src="screenshots/qa-mobile-dock.png" alt="Dock mobile" width="280" />
  &nbsp;
  <img src="screenshots/qa-substances-mobile.png" alt="Substances mobile" width="280" />
  &nbsp;
  <img src="screenshots/qa-inbox-mobile.png" alt="Notifs mobile" width="280" />
</p>
...
Toutes les versions et correctifs, de la plus récente à la première.
